...
model = models.vgg11(pretrained=False, num_classes=num_classes).to(device)
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        if err.mean() <= best_avg:
            ...
            best_avg = err.mean()
            best_ep = epoch
    print('Epoch valid error in epoch: ', epoch+1, 'is: ', err)
    ...
    if patience > 8:
       torch.save(model, '/home/vahidn/projects/def-banire/vahidn/CLT/VGG18.pt')
       break
