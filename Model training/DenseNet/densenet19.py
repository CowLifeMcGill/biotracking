...
model = models.densenet121(pretrained=False, num_classes=num_classes).to(device)
...
for epoch in range(num_epochs):
    ...
    if patience > 8:
       torch.save(model, '/home/vahidn/projects/def-banire/vahidn/CLT/DenseNet19.pt')
       break
...
#with open('/home/vahidn/projects/def-banire/vahidn/CLT/train_errors_densenet_g1.pkl", "wb") as file:
#    pickle.dump(train_error, file)
